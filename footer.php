...
?>
		...
		<footer id="colophon" class="site-footer" role="contentinfo">
			...
			<div class="site-info ">
				...
				<p class="left"><?php _e( 'Theme by', 'lifeisgood' ); ?> <a href="<?php echo esc_url( __( 'http://www.daniel-klose.com/', 'lifeisgood' ) ); ?>" title="<?php esc_attr_e( 'Daniel-Klose.com', 'lifeisgood' ); ?>"><?php _e( 'Daniel-Klose.com', 'lifeisgood' ); ?></a></p>
